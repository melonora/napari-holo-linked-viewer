...
class HoloVizWidget(QWidget):
    def __init__(self, layer, stream):
        ...
        print(pn.models.browser.BrowserInfo())
    ...
    def _update_on_stream_selection(self):
        if self._current_selection != self.stream.index:
            self.layer.selected_data = self.stream.index
        if not self.stream.index and self.layer.selected_data:
